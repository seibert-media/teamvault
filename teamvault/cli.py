...
def upgrade(_pargs):
    ...
    if getattr(settings, 'LDAP_AUTH_ENABLED', False) and getattr(settings, 'AUTH_LDAP_GROUP_ENTRY_UUID_ATTR', None):
        ...
        try:
            ...
            print('### Run "teamvault plumbing sync_group_entry_uuids" manually once LDAP is reachable.\n')
